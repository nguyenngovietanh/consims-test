...
const model = require("../models/senobject.js");
const express = require('express');
const router = express.Router();
const views = {
    list: { 'path': 'pages/senobject', 'title': 'List Objects' },
    create: { 'path': 'pages/senobjectupdate', 'title': 'Create Object' },
    update: { 'path': 'pages/senobjectupdate', 'title': 'Update Object' }
};
