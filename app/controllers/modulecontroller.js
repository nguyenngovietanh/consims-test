...
const model = require("../models/module.js");
const express = require('express');
const router = express.Router();
const views = {
    list: { 'path': 'pages/module', 'title': 'Modules Management' },
    create: { 'path': 'pages/moduleupdate', 'title': 'Create Module' },
    update: { 'path': 'pages/moduleupdate', 'title': 'Update Module' }
};
