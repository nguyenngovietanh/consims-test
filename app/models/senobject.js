...
const meta = [
  ...
  {
    field: 'Lookup', type: 'string', description: 'Lookup', isnullable: true, show: true, visible: true, readonly: false, lookup: {
  ...
  { field: 'Numeric', type: 'numeric', dec: 3, description: 'Numeric',allowsummary: true, isnullable: false, show: true, visible: true },
  { field: 'String', type: 'string', description: 'String', isnullable: true, show: false, visible: true },
  { field: 'Options', type: 'string', description: 'Options', isnullable: true, show: true, visible: true, inputtype: 'select', sortable: false, data: [{ id: '', value: '', label: '' }, { id: '1', value: '1', label: 'Option 1' }, { id: '2', value: '2', label: 'Option 2' }, { id: '3', value: '3', label: 'Option 3' }] },

  { field: 'DateTime', type: 'datetime', description: 'DateTime', isnullable: true, show: false, visible: true },
  { field: 'Boolean', type: 'boolean', description: 'Boolean', isnullable: true, show: true, visible: true, inputtype: 'checkbox',readonly:false },
...
class Model {
  constructor({ GId, Id, Bigint, Numeric, String, Options, Lookup, LookupMulti, DateTime, Boolean, Date: DateValue, Text } = {}) {
    this.GId = GId ?? '';
    this.Id = Id ?? 0;
...
// Tạo dữ liệu mẫu
const sampleData = [
  { GId: '1', Id: 1, Bigint: 100, Numeric: 200, String: 'Sample 1', Options: '1', Lookup: 'Vietname', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-01T08:00:00'), Boolean: true, Date: new Date('2024-01-01'), Text: 'This is a sample text.' },
  { GId: '2', Id: 2, Bigint: 300, Numeric: 200, String: 'Sample 2', Options: '2', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-01-02T09:15:00'), Boolean: false, Date: new Date('2024-01-02'), Text: 'Another sample text.' },

  { GId: '3', Id: 3, Bigint: 500, Numeric: 600, String: 'Sample 3', Options: '3', Lookup: 'Thailand', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-03T10:30:00'), Boolean: true, Date: new Date('2024-01-03'), Text: 'Sample text 3.' },
  { GId: '4', Id: 4, Bigint: 700, Numeric: 200, String: 'Sample 4', Options: '1', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-04T11:45:00'), Boolean: false, Date: new Date('2024-01-04'), Text: 'Sample text 4.' },
  { GId: '5', Id: 5, Bigint: 900, Numeric: 1000, String: 'Sample 5', Options: '2', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-05T13:00:00'), Boolean: true, Date: new Date('2024-01-05'), Text: 'Sample text 5.' },
  { GId: '6', Id: 6, Bigint: 1100, Numeric: 1200, String: 'Sample 6', Options: '3', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-06T14:15:00'), Boolean: false, Date: new Date('2024-01-06'), Text: 'Sample text 6.' },
  { GId: '7', Id: 7, Bigint: 1300, Numeric: 1400, String: 'Sample 7', Options: '1', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-07T15:30:00'), Boolean: true, Date: new Date('2024-01-07'), Text: 'Sample text 7.' },
  { GId: '8', Id: 8, Bigint: 1500, Numeric: 1600, String: 'Sample 8', Options: '2', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-01-08T16:45:00'), Boolean: false, Date: new Date('2024-01-08'), Text: 'Sample text 8.' },
  { GId: '9', Id: 9, Bigint: 1700, Numeric: 1800, String: 'Sample 9', Options: '3', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-01-09T18:00:00'), Boolean: true, Date: new Date('2024-01-09'), Text: 'Sample text 9.' },

  { GId: '10', Id: 10, Bigint: 1900, Numeric: 2000, String: 'Sample 10', Options: '1', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-01-10T19:15:00'), Boolean: false, Date: new Date('2024-01-10'), Text: 'Sample text 10.' },
  { GId: '11', Id: 11, Bigint: 2100, Numeric: 2200, String: 'Sample 11', Options: '2', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-01-11T20:30:00'), Boolean: true, Date: new Date('2024-01-11'), Text: 'Sample text 11.' },
  { GId: '12', Id: 12, Bigint: 2300, Numeric: 2400, String: 'Sample 12', Options: '3', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-01-12T21:45:00'), Boolean: false, Date: new Date('2024-01-12'), Text: 'Sample text 12.' },
  //viết tiếp các dữ liệu mẫu
  { GId: '23', Id: 23, Bigint: 4500, Numeric: 4600, String: 'Sample 23', Lookup: 'Cambodia', LookupMulti: 'Vietnam,Cambodia', DateTime: new Date('2024-02-08T08:00:00'), Boolean: true, Date: new Date('2024-02-08'), Text: 'Sample text 23.' },
  { GId: '24', Id: 24, Bigint: 4700, Numeric: 4800, String: 'Sample 24', Lookup: 'Thailand', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-02-09T09:30:00'), Boolean: false, Date: new Date('2024-02-09'), Text: 'Sample text 24.' },
  { GId: '25', Id: 25, Bigint: 4900, Numeric: 5000, String: 'Sample 25', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-02-10T10:45:00'), Boolean: true, Date: new Date('2024-02-10'), Text: 'Sample text 25.' },
  { GId: '26', Id: 26, Bigint: 5100, Numeric: 5200, String: 'Sample 26', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-02-11T12:00:00'), Boolean: false, Date: new Date('2024-02-11'), Text: 'Sample text 26.' },
  { GId: '27', Id: 27, Bigint: 5300, Numeric: 5400, String: 'Sample 27', Lookup: 'Cambodia', LookupMulti: 'Vietnam,Cambodia', DateTime: new Date('2024-02-12T13:15:00'), Boolean: true, Date: new Date('2024-02-12'), Text: 'Sample text 27.' },
  { GId: '28', Id: 28, Bigint: 5500, Numeric: 5600, String: 'Sample 28', Lookup: 'Vietnam', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-02-13T14:30:00'), Boolean: false, Date: new Date('2024-02-13'), Text: 'Sample text 28.' },
  { GId: '29', Id: 29, Bigint: 5700, Numeric: 5800, String: 'Sample 29', Lookup: 'Thailand', LookupMulti: 'Vietnam,Thailand', DateTime: new Date('2024-02-14T15:45:00'), Boolean: true, Date: new Date('2024-02-14'), Text: 'Sample text 29.' },
  { GId: '30', Id: 30, Bigint: 5900, Numeric: 6000, String: 'Sample 30', Lookup: 'Lao', LookupMulti: 'Vietnam,Lao', DateTime: new Date('2024-02-15T17:00:00'), Boolean: false, Date: new Date('2024-02-15'), Text: 'Sample text 30.' }
